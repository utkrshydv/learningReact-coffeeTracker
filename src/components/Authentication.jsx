...
export default function Authentication(props) {
    ...
    return (
        <>
            ...
            <input value={email} 
            onChange={(e) => { setEmail(e.target.value) }} placeholder="eg: test@gmail.com" />
            <input value={password} onChange={(e) => { setPassword(e.target.value) }} placeholder="eg: 12345678" type="password" />
